...
logfile = open("STAGATE_Ellipse_10p_MultiSeed_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
# --- Parameters ---
sim_data_path = "/scratch/user/varogovchenko/BASTION_HPRC/Simulations/Ellipse/Ellipse_sim_data.csv"
num_clusters = 5
...
csv_dir = os.path.join(base_dir, 'res_simdata_ellipse_10p_csv')
