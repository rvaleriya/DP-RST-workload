...
log_file_path = "GraphST_Ellipse_3p_MultiSeed_output.log"
output_dir_csv = "res_ellipse_3p_csv"
seeds_to_run = [
...
output_path = os.path.join(output_dir_csv, f"graphst_ellipse_3p_multiseed_k{num_clusters}_radius{graph_radius}_results.csv")
