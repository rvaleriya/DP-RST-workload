...
K_set = 5 # Numbers of mixture components
...
Ellipse_sim_SC.MEB_p10_reps <- list()
...
for (s in 1:length(seeds)){
  ...
  Ellipse_sim_SC.MEB_p10_reps[[s]] <- SC.MEB_fit
}

# Save the results of the repetitive runs
save(Ellipse_sim_SC.MEB_p10_reps, file = "./New_Simulations/Ellipse/Ellipse_results/Ellipse_sim_SC.MEB_p10_30reps.RData")
