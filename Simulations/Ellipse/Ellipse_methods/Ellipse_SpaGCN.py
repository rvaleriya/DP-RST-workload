...
SIM_LOG_FILENAME = "SpaGCN_analysis_ellipse_multi_seed_3p.log"
...
def load_simulated_data(csv_path):
    ...
    required_cols = ['x', 'y', 'PC1', 'PC2', 'PC3', 'super_cluster'] # Added 'cluster'
    ...
    adata = ad.AnnData(X=df[['PC1', 'PC2', 'PC3']].values)
...
def main():
    ...
    # --- Configuration ---
    SIM_DATA_CSV = "/scratch/user/varogovchenko/BASTION_HPRC/Simulations/Ellipse/Ellipse_sim_data.csv"
    N_CLUSTERS = 5 # Number of clusters requested (used for kmeans init)
    NUM_PCS = 3 # Since Y1, Y2, Y3 are the features used
    OUTPUT_DIR = Path("./res_ellipse_data_3p")
    ...
    results_csv_path = OUTPUT_DIR / "ellipse_spagcn_clustering_results_3p_multi_seed.csv"
