...
BURNIN = 12000 # burnin period length
...
Ellipse_sim_BAST_p10_reps <- list()
...
for (s in 1:length(seeds)){
  ...
  Ellipse_sim_BAST_p10_reps[[s]] <- Ellipse_sim_BAST

  cat('Loop', s, 'done\n')
}

# Save the results of the repetitive runs
save(Ellipse_sim_BAST_p10_reps, file = "Simulations/Ellipse/Ellipse_sim_BAST_p10_30reps.RData")
