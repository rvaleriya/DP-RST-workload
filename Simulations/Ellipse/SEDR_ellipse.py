...
# --- Configuration ---
data_file = "/scratch/user/varogovchenko/BASTION_HPRC/Simulations/Ellipse/Ellipse_sim_data.csv"
output_dir_csv = "res_ellipse_10p_csv"
log_file_path = "SEDR_Ellipse_10p_MultiSeed_output.log" # Updated log file name
...
num_clusters = 5 # Based on 'cluster' column in data
graph_neighbors = 30 
...
adata.var_names = ['Y1', 'Y2', 'Y3', 'Y4', 'Y5', 'Y6', 'Y7', 'Y8', 'Y9', 'Y10'] # Name the features
...
csv_filename = os.path.join(output_dir_csv, f"sedr_ellipse_10p_multiseed_k{num_clusters}_results.csv")
