...
log_file_path = "GraphST_Ushape_MultiSeed_output.log"
output_dir_csv = "res_ushape_csv"
seeds_to_run = [
...
# --- Load Data ---
data_file = "/scratch/user/varogovchenko/BASTION_HPRC/Simulations/U_sim_6k/sim_data_ushape.csv"
...
output_path = os.path.join(output_dir_csv, f"graphst_ushape_multiseed_k{num_clusters}_radius{graph_radius}_results.csv")
