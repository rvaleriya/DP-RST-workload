...
logfile = open("STAGATE_Ushape_MultiSeed_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
# --- Parameters ---
sim_data_path = "/scratch/user/varogovchenko/BASTION_HPRC/Simulations/U_sim_6k/sim_data_ushape.csv"
num_clusters = 6
input_features = ['Y1', 'Y2', 'Y3']
spatial_coords = ['x', 'y']
rad_cutoff_val = 3 # Set based on previous findings
ground_truth_col = 'cluster' # Column name for ground truth clusters in input CSV
...
csv_dir = os.path.join(base_dir, 'res_simdata_ushape_csv')
