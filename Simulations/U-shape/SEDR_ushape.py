...
log_file_path = "SEDR_Ushape_MultiSeed_output.log" # Updated log file name
...
num_clusters = 6 # Based on 'cluster' column in data
graph_neighbors = 30 
...
observations = df[['cluster']].copy() # Keep original labels
