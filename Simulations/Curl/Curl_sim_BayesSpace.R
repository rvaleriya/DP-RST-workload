...
Curl_sim_BayesSpace_p3_reps <- list()
...
for (s in 1:length(seeds)){
  ...
  Curl_sim_BayesSpace_p3_reps[[s]] <- BS_results
}

# Save the results of the repetitive runs
save(Curl_sim_BayesSpace_p3_reps, file = "./New_Simulations/Curl/Curl_results/Curl_sim_BayesSpace_p3_30reps.RData")
