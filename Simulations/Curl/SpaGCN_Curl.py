...
SIM_LOG_FILENAME = "SpaGCN_analysis_curl_multi_seed_10p.log"
...
def main():
    ...
    NUM_PCS = 10 # Since Y1, Y2, Y3 are the features used
    OUTPUT_DIR = Path("./res_curl_data_10p")
    ...
    if ari_scores_initial or ari_scores_refined:
        ...
        if plot_data:
            try:
                ...
                plt.tight_layout()
                boxplot_path = OUTPUT_DIR / "simulated_ari_boxplot_comparison_10p.png"
    ...
    results_csv_path = OUTPUT_DIR / "curl_spagcn_clustering_results_10p_multi_seed.csv"
