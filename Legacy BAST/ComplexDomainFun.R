...
# Install the Rfast package
# if (!requireNamespace("Rfast", quietly = TRUE)) {
#   install.packages("Rfast", lib = my_lib_path)
# }
library(Rfast)

# if (!requireNamespace("extraDistr", quietly = TRUE)) {
#   install.packages("extraDistr", lib = my_lib_path)
# }
library(extraDistr)

# if (!requireNamespace("matrixNormal", quietly = TRUE)) {
#   install.packages("matrixNormal", lib = my_lib_path)
# }
library(matrixNormal)

# if (!requireNamespace("MCMCpack", quietly = TRUE)) {
#   install.packages("MCMCpack", lib = my_lib_path)
# }
library(MCMCpack)
