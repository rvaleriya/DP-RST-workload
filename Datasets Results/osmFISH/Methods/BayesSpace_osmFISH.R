###############################################################################
#                BayesSpace on osmFISH (Radius-Based Neighbors)
#-------------------------------------------------------------------------------
...
sce <- readRDS("osmfish_sce_with_pca.rds")
...
# ========================== 5. Run BayesSpace ================================
run_bayes_custom <- function(sce, df_j, n_pcs, q = 11, burn.in = 40000, nrep = 50000) {
...
saveRDS(df_3, "Results/BayesSpace_osmFISH_3PCs.rds")
...
saveRDS(df_10, "Results/BayesSpace_osmFISH_10PCs.rds")
