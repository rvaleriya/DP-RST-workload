...
load("./Breast/breast_boundary.RData")
...
#-------------------------------------------------------------------------------
file_path <- "./Breast/DP-RST_Outputs/Breast_DP.RST_newBS_p10_Version2_OutputOnly.RData"
load(file_path)
output = Breast_DP.RST_newBS_p10_Version2

file_path_bast <- "./Breast/DP-RST_Outputs/Breast_BAST_PT_Version2_1_50k_diff01_newBS_OutputOnly.RData"
load(file_path_bast)
