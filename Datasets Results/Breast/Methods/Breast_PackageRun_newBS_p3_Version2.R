...
Breast_DP.RST_newBS_p3_Version2 = DP.RST(Y_std, graph0, init_val, hyperpar,
                                     MCMC, BURNIN, THIN,
...
save(Breast_DP.RST_newBS_p3_Version2, file = "/Breast/NewRuns_2025/Outputs_DP-RST/Breast_DP.RST_newBS_p3_Version2_OutputOnly.RData")
