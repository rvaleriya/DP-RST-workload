...
# Logging
# =========================
LOGFILE = "SpaGCN_Breast_output.log"
...
OUTPUT_CSV = "SpaGCN_Breast.csv"
OUTPUT_ARI_TXT = "SpaGCN_Breast_ARI.txt"
OUTPUT_PLOT = "SpaGCN_Breast_plot.png"
...
if ari_rows:
    ...
    with open(OUTPUT_ARI_TXT, "w") as f:
        f.write("SpaGCN on Breast (k=5) — ARI summary\n")
        f.write("="*60 + "\n")
...
sc.pl.spatial(adata_plot_base, color="refined_3PCs", ax=axes[0], show=False, 
              title=f'Breast - 3PCs (k={N_CLUSTERS})', spot_size=120)

# 10PCs results
sc.pl.spatial(adata_plot_base, color="refined_10PCs", ax=axes[1], show=False, 
              title=f'Breast - 10PCs (k={N_CLUSTERS})', spot_size=120)
