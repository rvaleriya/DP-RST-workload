...
# --- 1. Set up logging ---
logfile = open("STAMarker_Breast_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile

# --- 2. Load and preprocess data ---
base_path = "../../ST_Datasets/Breast"
...
model = STAMarker(5, "Breast_STAMarker_output/", config)
...
all_true_labels_df = pd.read_csv("../../ST_Datasets/Breast/breast_true_labels.csv")
...
plt.tight_layout()
plt.savefig("Breast_STAMarker.png")
...
# Save to CSV
output_df.to_csv("STAMarker_Breast_joint.csv", index=False)