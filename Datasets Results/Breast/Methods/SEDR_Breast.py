...
logfile = open("SEDR_Breast_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
ari_results = {}
gt_csv_path = os.path.join(dataset_path, "breast_true_labels.csv")
...
if ari_results:
    ...
    with open("breast_sedr_ari.txt", "w") as f:
        for line in ari_lines:
            f.write(line + "\n")
    print("✓ Saved ARI summary to breast_sedr_ari.txt")
