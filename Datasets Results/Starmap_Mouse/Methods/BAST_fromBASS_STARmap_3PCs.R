...
preproc_file  <- file.path(full_dir, "Full_Preproc_BAST_3PCs.RData")  # <- 3PCs file
...
# Output/backup paths
out_file   <- file.path(full_dir, "Full_Result_BAST_3PCs.RData")
backup_d   <- file.path(full_dir, "Full_Result_BAST_3PCs_backup.RData")
