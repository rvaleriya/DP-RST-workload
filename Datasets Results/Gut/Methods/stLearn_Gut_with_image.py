#!/usr/bin/env python3
"""
stLearn clustering analysis for Gut dataset WITH histology image processing.
"""
import numpy as np
import pandas as pd
...
OUT_DIR = Path(".")
TILE_DIR = Path("/tmp/tiles_gut_with_image")
...
# Subset to selected spots (as in STAGATE script)
print("\nSubsetting Gut to selected spots...")
gut_reduced_path = BASE_PATH / "Gut_reduced"
