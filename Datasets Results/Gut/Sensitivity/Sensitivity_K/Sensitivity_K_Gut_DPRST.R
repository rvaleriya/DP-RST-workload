...
setwd("/scratch/user/varogovchenko/BASTION_HPRC/GSE169749_RAW-2")
out_dir <- "/scratch/user/varogovchenko/BASTION_HPRC/GSE169749_RAW-2/NewRuns_2025/Sensitivity_K_PC10/Outputs_DPRST"
bast_dir <- "/scratch/user/varogovchenko/BASTION_HPRC/GSE169749_RAW-2/NewRuns_2025/Sensitivity_K_PC10/Outputs_BAST"
...
K_clusters <- 30
bast_part <- file.path(bast_dir, paste0(sprintf("Gut_BAST_PT_k%02d", K_clusters), "_OutputOnly.RData"))
load(bast_part)

out_path <- file.path(out_dir, paste0(sprintf("Gut_DPRST_PT_k%02d", K_clusters), "_OutputOnly.RData"))
...
print("Recovered spatial clusters from BAST")
print(table(clusters_bast))
...
Gut_DP.RST = DP.RST(Y_std, graph0, init_val, hyperpar,
                                        MCMC, BURNIN, THIN,
