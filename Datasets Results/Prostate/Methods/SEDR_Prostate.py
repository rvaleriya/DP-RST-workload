...
logfile = open("SEDR_Prostate_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
ari_results = {}
gt_csv_path = os.path.join(dataset_path, "prostate_true_labels.csv")
...
combined_out = "SEDR_Prostate.csv"
...
if ari_results:
    ...
    with open("prostate_sedr_ari.txt", "w") as f:
        for line in ari_lines:
            f.write(line + "\n")
    print("✓ Saved ARI summary to prostate_sedr_ari.txt")
