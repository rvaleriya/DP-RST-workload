...
logfile = open("STAGATE_Prostate_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
results_file = os.path.join(base_dir, "STAGATE_Prostate.csv")
...
true_labels_csv = os.path.join(dataset_path, "prostate_true_labels.csv")
...
if ground_truth_col:
    ...
    ari_file = os.path.join(base_dir, "STAGATE_Prostate_ARI.txt")
...
plt.tight_layout()
plot_file = os.path.join(base_dir, "STAGATE_Prostate_plot.png")
