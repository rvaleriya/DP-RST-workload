...
results = readRDS("/Prostate/NewRuns_2025/Outputs_BAST/Prostate_BAST_PT_Version2_newBS_OutputOnly.rds")
...
Prostate_DP.RST_newBS_p10_Version2 = DP.RST(Y_std, graph0, init_val, hyperpar,
                                                MCMC, BURNIN, THIN,
...
saveRDS(Prostate_DP.RST_newBS_p10_Version2, file = "/Prostate/NewRuns_2025/Outputs_DP-RST/Prostate_DP.RST_newBS_p10_Version2_OutputOnly.rds")
