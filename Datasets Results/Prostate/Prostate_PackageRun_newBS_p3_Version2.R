...
Prostate_DP.RST_newBS_p3_Version2 = DP.RST(Y_std, graph0, init_val, hyperpar,
                                                MCMC, BURNIN, THIN,
...
saveRDS(Prostate_DP.RST_newBS_p3_Version2, file = "/Prostate/NewRuns_2025/Outputs_DP-RST/Prostate_DP.RST_newBS_p3_Version2_OutputOnly.rds")
