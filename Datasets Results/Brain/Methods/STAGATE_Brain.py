...
logfile = open("STAGATE_Brain_output.log", "w")
sys.stdout = logfile
sys.stderr = logfile
...
results_file = os.path.join(base_dir, "STAGATE_Brain.csv")
...
true_labels_csv = os.path.join(dataset_path, "brain_true_labels.csv")
...
if ground_truth_col and ground_truth_col in adata.obs.columns:
    ...
    ari_file = os.path.join(base_dir, "STAGATE_Brain_ARI.txt")
...
plt.tight_layout()
plot_file = os.path.join(base_dir, "STAGATE_Brain_plot.png")
