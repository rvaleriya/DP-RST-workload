...
# Logging
# =========================
LOGFILE = "SpaGCN_Brain_output.log"
...
OUTPUT_CSV = "SpaGCN_Brain.csv"
OUTPUT_ARI_TXT = "SpaGCN_Brain_ARI.txt"
OUTPUT_PLOT = "SpaGCN_Brain_plot.png"
...
if ari_rows:
    ...
    with open(OUTPUT_ARI_TXT, "w") as f:
        f.write("SpaGCN on Brain (k=7) — ARI summary\n")
        f.write("="*60 + "\n")
...
sc.pl.spatial(adata_plot_base, color="refined_3PCs", ax=axes[0], show=False, 
              title=f'Brain - 3PCs (k={N_CLUSTERS})', spot_size=120)

# 10PCs results
sc.pl.spatial(adata_plot_base, color="refined_10PCs", ax=axes[1], show=False, 
              title=f'Brain - 10PCs (k={N_CLUSTERS})', spot_size=120)
