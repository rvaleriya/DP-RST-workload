###############################################################################
#                      k-means on Colon Xenium: 3 PCs & 10 PCs
...
# ========================== 2) Paths & Data ==================================
work_dir   <- "/scratch/user/varogovchenko/Kmeans_runs/Colon"
...
#   spatial_keep    : tibble with columns: ID, x, y, Annotation_Type
...
run_kmeans_with_pcs <- function(Y, n_pcs, K, xy, truth = NULL, dataset_tag = "Colon", out_dir = ".") {
...
res_10 <- run_kmeans_with_pcs(pca_embeddings, n_pcs = 10, K = K, xy = xy_mat,
                              truth = truth_vec, dataset_tag = "Colon", out_dir = out_dir)
...
print(file_time)
cat("Finished k-means runs on Colon Xenium.\n")
###############################################################################