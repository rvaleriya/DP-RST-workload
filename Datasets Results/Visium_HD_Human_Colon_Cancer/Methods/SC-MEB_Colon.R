###############################################################################
#                  SC.MEB on Colon Xenium: 3 PCs & 10 PCs (K = 6)
...
# ========================== 2) Paths & Data ==================================
work_dir   <- "/scratch/user/varogovchenko/SCMEB_runs/Colon"
...
print(file_time)
cat("Finished SC.MEB runs on Colon Xenium.\n")
###############################################################################