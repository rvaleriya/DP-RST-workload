...
out_dir <- file.path(base_dir, "BAST_Shards_10PC")
...
ann       <- as.matrix(spatial_keep[, c("annotation")])
Y_sample  <- as.matrix(pca_embeddings[, c("PC_1", "PC_2", "PC_3", "PC_4", "PC_5", "PC_6", "PC_7", "PC_8", "PC_9", "PC_10")])
n         <- nrow(Y_sample)
p         <- ncol(Y_sample)
