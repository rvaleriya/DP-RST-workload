...
res_dir  <- "/scratch/user/varogovchenko/BASTION_HPRC/Lung_Xenium/BAST_Results_10PC"
pre_dir  <- "/scratch/user/varogovchenko/BASTION_HPRC/Lung_Xenium/BAST_Shards_10PC"
post_dir <- "/scratch/user/varogovchenko/BASTION_HPRC/Lung_Xenium/Shards_PostBAST_10PC"
